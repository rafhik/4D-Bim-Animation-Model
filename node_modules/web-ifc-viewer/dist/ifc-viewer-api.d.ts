...
import { IfcContext, IfcManager, ViewerOptions, IfcGrid, IfcAxes, IfcClipper, DropboxAPI, IfcStats, Edges, SectionFillManager, IfcDimensions } from 'web-ifc-viewer/dist/components';
import { GLTFManager } from 'web-ifc-viewer/dist/components/import-export/glTF';
