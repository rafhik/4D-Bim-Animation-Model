import { ParserAPI, ParserProgress } from 'web-ifc-three/IFC/components/IFCParser';
import { HighlightConfigOfModel, JSONObject } from 'web-ifc-three/IFC/BaseDefinitions';
...
export declare class IFCManager {
     ...
     */
    get ifcAPI(): import("web-ifc-three/IFC/BaseDefinitions").WebIfcAPI;
